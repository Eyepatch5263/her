...
import { ExcitementProvider } from "@/context/ExcitementContext";
    ...
    <ExcitementProvider>
      <main className="relative min-h-screen bg-[#050505] text-[#f5f5f5] selection:bg-[#3b82f6]/30 selection:text-[#3b82f6]">
        ...
        >
          ...
          {/* 5. Photo Gallery Parallax Section */}
          <Gallery />

          {/* 6. Featured Motion Reels & Video Section */}
          <FeaturedVideos />

          {/* 7. Little Things I Love Section */}
          <LittleThings />

          {/* 8. Love Notes Section */}
          <LoveNotes />

          {/* 9. Milestones & Days Counter */}
          <Milestones />

          {/* 10. Closing Section & Signature */}
